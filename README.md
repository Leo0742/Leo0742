...
**Python / FastAPI / SQL / Docker · Developer tools · Exploring Go Backend and Applied ML**

I build backend APIs, automation tools, desktop apps, browser extensions, parsers, Telegram bots, and practical developer utilities.
...
**Automation, web, desktop & extensions**
...
<a href="https://developers.google.com/machine-learning" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/badge/Applied_ML-4F46E5?style=for-the-badge&logo=google&logoColor=FFFFFF" alt="Applied ML" /></a>
...
My strongest backend portfolio project: a full-stack lost-and-found platform with a **FastAPI** backend, **PostgreSQL** database, **React** frontend, Telegram bot, report lifecycle, search/matching, claims, moderation workflow, health checks, and Docker Compose deployment.

`Python` · `FastAPI` · `SQLAlchemy` · `PostgreSQL` · `React` · `Telegram Bot` · `Docker`

### [Inno Code](https://github.com/Leo0742/Inno-Code)

A desktop coding assistant that runs multi-agent planning and keeps repository changes behind explicit review and approval. The Electron app supports persisted sessions, exact sandbox previews, selective patch application, runtime logs, provider profiles, and validation commands.
...
### [QuizMind Platform](https://github.com/Leo0742/QuizMind_Platform) <sub>contributed project · fork</sub>

A contributed fork of a SaaS-style platform foundation with a Next.js web app, NestJS API, worker service, shared packages, PostgreSQL, Redis, Docker, auth, feature flags, remote config, and support/admin workflows.
...
- Preparing for **remote internship, trainee, and junior backend/automation roles**
- Strengthening backend fundamentals with **Python, FastAPI, SQL, Docker, testing, and clean architecture**
- Building **automation, browser tooling, and developer tools**
- Adding stronger **API tests, frontend smoke tests, and CI** to portfolio projects
- Learning **Go** for backend services and concurrent systems
- Studying **applied ML/AI fundamentals** through practical product integrations
- Improving my ability to **explain, test, and maintain code independently**, not only through AI assistance

## Contact

Open to remote internships, trainee positions, and junior developer opportunities in backend development, automation, QA automation, and developer tooling.